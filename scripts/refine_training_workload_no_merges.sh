...
OPTS="-o /mnt/ocfs2/IDF_data/journals/exp_triples/histogram/test/experiments/infinite_fixed_root_no_merges/"

CP=${ABS_PATH}/jars/refine_training_workload_no_merges.jar
