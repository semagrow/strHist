...
OPTS="-o /mnt/ocfs2/IDF_data/journals/exp_triples/histogram/test/experiments/infinite_fixed_root_with_merges_1200/"

CP=${ABS_PATH}/jars/refine_training_workload_with_merges_1200.jar
