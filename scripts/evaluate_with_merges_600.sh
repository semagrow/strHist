...
OPTS="-o /mnt/ocfs2/IDF_data/journals/exp_triples/histogram/test/experiments/infinite_fixed_root_with_merges_600/ -i /mnt/ocfs2/IDF_data/journals/exp_triples/"
