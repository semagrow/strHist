 ...
 */
public class RDFCircle implements Rectangle<RDFCircle> {

    private RDFStrRange subjectRange;
    ...
    public RDFCircle(RDFStrRange subjectRange,
    ...
    public RDFCircle intersection(RDFCircle rec) {
        return new RDFCircle(subjectRange.intersection(rec.subjectRange),
                predicateRange.intersection(rec.predicateRange),
                objectRange.intersection(rec.objectRange));
    }


    public boolean contains(RDFCircle rec) {
...
//			return this.contains(rec) && rec.contains(this);
    ...
    public boolean intersects(RDFCircle rec) {
    ...
    public void shrink(RDFCircle rec) {

        RDFStrRange subjectRangeN = subjectRange.minus(rec.subjectRange);
    ...
    public RDFCircle computeTightBox(RDFCircle rec) {

        RDFStrRange subjectRangeN = subjectRange.tightRange(rec.subjectRange);
        ...
        return new RDFCircle(subjectRangeN, predicateRangeN, objectRangeN);
    }
    ...
    public void setSubjectRange(RDFStrRange subjectRange) {
        this.subjectRange = subjectRange;
    }
    ...
    public boolean isMergeable(RDFCircle rec) {
    ...
    public boolean isEnclosing(RDFCircle r) {
